...
describe("reverse", function () {
  it("reverse the places of a linkedlist", function () {
    let lst = new LinkedList([2, 3, 1, 1, 7, 6, 9]);
    lst.reverse()

    expect(lst.head.val).toBe(9);
    expect(lst.tail.val).toBe(2);
    expect(lst.getAt(1)).toBe(6);
    expect(lst.getAt(2)).toBe(7);
    expect(lst.getAt(3)).toBe(1);
    expect(lst.getAt(4)).toBe(1);
    expect(lst.getAt(5)).toBe(3);
    expect(lst.getAt(6)).toBe(2);
...
describe("pivot", function () {
  it("pivot", function () {
    ...
    expect(lst.getAt(1)).toBe(3);
    expect(lst.getAt(2)).toBe(1);
    expect(lst.getAt(3)).toBe(1);
    expect(lst.getAt(4)).toBe(7);
    expect(lst.getAt(5)).toBe(6);
    expect(lst.getAt(6)).toBe(9);
...
describe("SortSortedLinkedLists", function () {
  it("return new sorted linkedlist", function () {
    let lst1 = new LinkedList([1,2,3,4,5]);
    let lst2 = new LinkedList([2,4,6,8,10]);
    let lst = LinkedList.SortSortedLinkedLists(lst1 , lst2);

    expect(lst.head.val).toBe(1);
    expect(lst.tail.val).toBe(10);
    expect(lst.getAt(1)).toBe(2);
    expect(lst.getAt(2)).toBe(2);
    expect(lst.getAt(3)).toBe(3);
    expect(lst.getAt(4)).toBe(4);
    expect(lst.getAt(5)).toBe(4);
    expect(lst.getAt(6)).toBe(5);
    expect(lst.getAt(7)).toBe(6);
    expect(lst.getAt(8)).toBe(8);
    expect(lst.getAt(9)).toBe(10);
